...
export const API_SEARCH = `${API_BASE}/search/movie?include_adult=true&language=en-US&&api_key=${API_KEY}`;
export const API_MOVIE_INFO_BASE = `${API_BASE}/movie/`;
export const API_MOVIE_INFO_PARAMS = `?append_to_response=videos&language=en-US&api_key=${API_KEY}`;
